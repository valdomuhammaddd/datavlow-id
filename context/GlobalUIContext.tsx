...
const MESSAGES: Record<LocaleCode, Record<string, string>> = {
  ID: {
    ...
    network: "Jaringan",
    devices: "Perangkat",
    analytics: "Buku Besar",
    settings: "Pengaturan",
    help: "Bantuan",
    logout: "Keluar",
    addDevice: "Tambah Perangkat",
    logicBuilder: "Pembuat Logika",
    simulation: "Simulasi",
    commandCenter: "Pusat Komando",
    historicalLedger: "Buku Besar Historis",
    historicalLedgerDesc:
      "Tabel data dari API buku besar. Grafik realtime ada di Dashboard.",
    export: "EKSPOR",
    ...
    precisionTelemetryDesc:
      "KPI live + grafik multi-garis (30 titik terakhir). Data spreadsheet ada di Buku Besar.",
    openSpreadsheetLedger: "BUKA BUKU BESAR",
    ...
    noLedgerRows:
      "Belum ada data buku besar — kirim telemetri ESP32 atau gunakan Simulasi.",
    pageOf: "Halaman",
    rows: "baris",
    timestamp: "Waktu",
    status: "Status",
  ...
  EN: {
    ...
    openSpreadsheetLedger: "OPEN LEDGER",
